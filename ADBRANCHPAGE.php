...
<body background="fim.png">
  ...
  $brdetails = $_SESSION['branchDetailsID'];

  $sql = "SELECT * FROM branch WHERE br_id='$brdetails'";
  ...
  $sql = "SELECT count(*) FROM account WHERE state='Open' and br_id='$brdetails';";
  $result = mysqli_query($conn, $sql);
  ...
  $sql = "SELECT count(*) FROM account WHERE state='Closed' and br_id='$brdetails';";
  $result = mysqli_query($conn, $sql);
  ...
  $sql = "SELECT count(*) FROM account WHERE br_id='$brdetails';";
  $result = mysqli_query($conn, $sql);
  ...
  $sql = "SELECT * FROM manager WHERE br_id='$brdetails';";
  $result = mysqli_query($conn, $sql);
  ...
  $sql = "SELECT count(*) FROM staff WHERE br_id = '$brdetails';";
  $result = mysqli_query($conn, $sql);
  ...
  <CENTER><button class="box boxes">
      ...
      <p>Branch ID<input style="float: right; background: transparent; background: transparent;" type="text"
          id="branchid" name="branchid" value="<?php echo $brdetails; ?>" readonly></p>
