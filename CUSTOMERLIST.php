...
<head>
  ...
  if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "SELECT * FROM customer WHERE cus_id ='$customerid' AND br_id='$brid'";
...
<body background="fim.png">
  ...
  <CENTER><button class="box boxes">
      ...
      <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
        <p>Customer ID<input style="float: right; background: transparent; background: transparent;" type="text"
            id="customerid" name="customerid" required></p>
        <br>
        <p>Customer Name<input style="float: right; background: transparent;" type="text" id="name" name="name"
